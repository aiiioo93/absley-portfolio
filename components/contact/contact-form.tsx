...
const contactSchema = z.object({
  ...
  email: z.string().email("Indique une adresse e-mail valide."),
  projectType: z.string().min(1, "Choisis un type de projet."),
  budget: z.string().optional(),
  message: z
    .string()
    .min(20, "Donne-moi quelques informations supplémentaires sur ton projet."),
})
...
export function ContactForm() {
  ...
  function onSubmit(data: ContactFormValues) {
    ...
    // Temporaire.
    // L'envoi réel sera branché avec Resend à l'étape suivante.
    setSubmitted(true)
  }
    ...
    return (
      <div className="flex min-h-[520px] flex-col items-center justify-center rounded-3xl border border-emerald-400/15 bg-emerald-400/[0.025] px-6 text-center">
        ...
        <p className="mt-4 max-w-md text-sm leading-7 text-[#8A98AA]">
          Le formulaire fonctionne correctement. L’envoi réel par e-mail sera
          connecté avec Resend à l’étape suivante.
        </p>
